...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        {
            yield return "Nie znaleziono przedmiotu z kategorii Analytics.";
        }
        else
        {
            yield return $"{przedmiot.Nazwa} | start: {przedmiot.DataStartu:yyyy-MM-dd}";
        }
    }
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        ...
        yield return $"Czy istnieje nieaktywny zapis: {(istnieje ? "Tak" : "Nie")}";
    }
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre()
    {
        ...
        yield return $"Czy wszyscy prowadzący mają przypisaną katedrę: {(wszyscy ? "Tak" : "Nie")}";
    }
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        ...
        yield return $"Liczba aktywnych zapisów: {liczba}";
    }
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        return DaneUczelni.Prowadzacy
            .GroupJoin(
                ...
                pr => pr.Id,
                p => p.ProwadzacyId,
                (pr, przedmioty) => $"{pr.Imie} {pr.Nazwisko} | przedmiotów: {przedmioty.Count()}");
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Studenci
            .Join(
                ...
                s => s.Id,
                z => z.StudentId,
                (s, z) => new { Student = s, Ocena = z.OcenaKoncowa!.Value })
            .GroupBy(x => x.Student)
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} | max ocena: {g.Max(x => x.Ocena):F1}");
    }
